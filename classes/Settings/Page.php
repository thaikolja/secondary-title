...
final class Page {
	...
	public function register(): void {
		add_action( self::ADMIN_MENU_HOOK, [ $this, 'add_menu' ] );
	}
	 ...
	 * $context['settings'] array (or $default).
	 *
	 ...
	 * @return mixed
	 */
	public static function setting_value( array $settings, string $key, mixed $default = null ): mixed {
